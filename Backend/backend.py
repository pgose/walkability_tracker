...
def data_analysis():
    ...
    query_context = "SELECT w.idx, w.geom FROM gta_p3.walkability_scoring AS w WHERE ST_Contains(ST_MakeEnvelope(8.486116935,47.383581166,8.525212241,47.411729786, 4326),w.geom)"
